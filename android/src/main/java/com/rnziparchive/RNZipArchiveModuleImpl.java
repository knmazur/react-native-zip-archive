...
public class RNZipArchiveModuleImpl  {
    ...
    public static String NAME = "RNZipArchive";

    private ReactApplicationContext reactContext;

    public RNZipArchiveModuleImpl(ReactApplicationContext reactContext) {
    ...
    public void unzipAssets(final String assetsPath, final String destDirectory, final Promise promise) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    assetsInputStream = reactContext.getAssets().open(assetsPath);
                    AssetFileDescriptor fileDescriptor = reactContext.getAssets().openFd(assetsPath);
